...
int main (int argc, char *argv[])
{
    ...
    char str01[300]="./CBSH2 -m instances/lak503d.map -o run_large110_base.csv -t 3600 -s 1 -h WDG -a instances/lak503dmap-110agents-";
    char str02[300]=".agents -k 110 -u 0 -d ";
    
    char str1[300]="./CBSH2 -m instances/lak503d.map -o run_large110_ML.csv -t 5400 -s 1 -h WDG -a instances/lak503dmap-110agents-";
    ...
    memset(command,0,sizeof(command));
    strcat(command,str01);
    strcat(command,strnum);
    strcat(command,str02);
    strcat(command,strnum);
    system(sleep);
    system(command);
...
/*
 ./CBSH2 -m instances/lak503d.map -o run_large110_base.csv -t 36 -s 1 -h WDG -a instances/lak503dmap-110agents-0.agents -k 110 -u 0 -d 0
./CBSH2 -m instances/lak503d.map -o run_large110_ML.csv -t 54 -s 1 -h WDG -a instances/lak503dmap-110agents-0.agents -u 4 --model featureLarge100/large_new2
